...
public class PrimaryCacheHandlerFactory  {
	...
	private CacheHandler<CacheableList> cacheHandler = null;
	public static PrimaryCacheHandlerFactory getInstance() {
		return instance;
	}
	
	public void setCacheHandler(CacheHandler<CacheableList> cacheHandler) {
		this.cacheHandler = cacheHandler;
	}
	
	public CacheHandler<CacheableList> getCacheHandler() {
		return cacheHandler;
	}
}
