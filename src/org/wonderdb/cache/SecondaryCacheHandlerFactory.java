...
public class SecondaryCacheHandlerFactory {
	...
	CacheHandler<ChannelBuffer> cacheHandler = null;
	
	public static SecondaryCacheHandlerFactory getInstance() {
		return instance;
	}
	
	public void setCacheHandler(CacheHandler<ChannelBuffer> handler) {
		cacheHandler = handler;
	}
	
	public CacheHandler<ChannelBuffer> getCacheHandler() {
		return cacheHandler;
	}
}
