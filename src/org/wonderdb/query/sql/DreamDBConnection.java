...
//    	BufferDecoder bufferDecoder = new BufferDecoder();
    	...
    	Connection c = DreamDBConnectionPool.getInstance().getConnection(host, port);
        factory =
...
//    	channel = future.getChannel();
	...
	public void close() throws SQLException {
		DreamDBConnectionPool.getInstance().returnConnection(this);
	}
	...
	public Statement createStatement() throws SQLException {
		return new DreamDBPreparedStatement(this, (String) null);
	}
	...
	public PreparedStatement executeSelect(ChannelBuffer buffer) {
		return new DreamDBPreparedStatement(this, buffer);
	}
