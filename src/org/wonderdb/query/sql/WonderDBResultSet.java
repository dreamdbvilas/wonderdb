...
import org.wonderdb.query.sql.WonderDBPreparedStatement.ResultSetValue;
import org.wonderdb.query.sql.WonderDBResultSetMetadata.ResultSetColumn;


public class WonderDBResultSet implements ResultSet {
	WonderDBResultSetMetadata metadata = null;
	WonderDBConnection connection = null;
	WonderDBPreparedStatement stmt = null;
	List<ResultSetValue> valueList = null;
	int currentPosn = -1;
	boolean closed = false;
	
	public WonderDBResultSet(WonderDBConnection connection, WonderDBPreparedStatement stmt, WonderDBResultSetMetadata metadata, List<ResultSetValue> list) {
