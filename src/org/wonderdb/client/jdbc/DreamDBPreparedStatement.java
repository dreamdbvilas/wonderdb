...
import org.wonderdb.client.jdbc.DreamDBConnection.WireData;
...
public class DreamDBPreparedStatement implements PreparedStatement {
	...
	public ResultSet executeQuery(String arg0) throws SQLException {
        ...
        List<ResultSetColumn> list = new ArrayList<DreamDBResultSetMetadata.ResultSetColumn>();
...
//        		count = data.buffer.readInt();
        ...
        bindValues.clear();
        return new DreamDBResuleSet(connection, this, metadata, rsvList);
	}
