...
public class DreamDBPropertyManager {
	...
	private static DreamDBPropertyManager instance = new DreamDBPropertyManager();
	private boolean initialized = false;
	private Properties properties = new Properties();
	
	private DreamDBPropertyManager() {
	}

	public static DreamDBPropertyManager getInstance() {
		return instance;
	}
