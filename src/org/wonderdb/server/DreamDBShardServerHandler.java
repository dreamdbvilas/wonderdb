...
public class DreamDBShardServerHandler extends SimpleChannelHandler {
	public static final int SERVER_HANDLER = 0;
	public static final int SHARD_HANDLER = 1;
	
	int handlerType = SHARD_HANDLER;
	
	public DreamDBShardServerHandler(int type) {
    ...
    public void messageReceived(ChannelHandlerContext ctx, MessageEvent e) {
    	...
    	try {
	    	if ("shutdown".equals(s)) {
	    		synchronized (DreamDBServer.lock) {
	    			DreamDBServer.shutdown = true;
	    			DreamDBServer.lock.notifyAll();
...
//    }
    ...
    public void channelOpen(ChannelHandlerContext ctx, ChannelStateEvent e) {
    	DreamDBServer.allServerChannels.add(e.getChannel());
    }    
